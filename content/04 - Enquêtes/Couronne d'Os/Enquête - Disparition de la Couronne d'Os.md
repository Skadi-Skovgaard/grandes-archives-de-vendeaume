...
priorite: haute
certitude: partielle
artefact: Couronne d'Os
tags:
  - enquete
  - couronne-os
---

# Enquête - Disparition de la Couronne d'Os

## Dernier porteur connu

Les recherches actuelles des Archivistes, sur la base des registres de Vendeaume et de certaines archives impériales, considèrent [[Ulfric Sombrage]] comme le dernier porteur connu de la [[Couronne d'Os]].

Sa dernière bataille se serait déroulée au [[Bosquet de Kyne]].
...
### [[Tombe d'Ylgar]]
Hypothèse secondaire : la Couronne aurait pu être restituée à un tombeau lié aux fils d'Ysgramor. L'emplacement de la tombe d'Ylgar est inconnu.
...
### Reconstituer l'après-mort d'Ulfric

- [ ] Qui a retrouvé son corps ?
- [ ] Qui a récupéré son équipement et ses effets personnels ?
- [ ] Où ont-ils été transportés ?
- [ ] À quel moment la Couronne disparaît-elle de la chaîne de possession ?
